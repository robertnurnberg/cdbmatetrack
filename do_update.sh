...
python3 cdbmatetrack.py --mateFile ChestUCI_23102018_cdbmates.epd >> cdbmatetrack.csv
python3 plotdata.py

git add ChestUCI_23102018_cdbeval.epd cdbmatetrack.csv ChestUCI_23102018_cdbmates.epd
